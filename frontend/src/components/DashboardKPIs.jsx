    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
                <div className="text-sm text-slate-500 uppercase tracking-wider font-semibold">Total Payroll</div>
                <div className="text-2xl font-bold text-slate-900 mt-1">
                    ${stats.totalPay.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </div>
                <div className="text-xs text-green-600 mt-2 font-medium">
                    {trips.length} Trips Processed
                </div>
            </div>
            ...
            {/* Fleet Stat */}
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
                <div className="text-sm text-slate-500 uppercase tracking-wider font-semibold">Avg Fleet Yield</div>
                <div className="text-2xl font-bold text-slate-900 mt-1">
