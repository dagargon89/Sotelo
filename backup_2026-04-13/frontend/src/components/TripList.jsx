...
export default function TripList({ trips, onUpdate, dieselPrice }) {
    ...
    return (
        <div className="space-y-6">
            {trips.map((trip, idx) => {
                ...
                return <CardComponent key={trip.id || idx} trip={trip} onUpdate={handleTripUpdate} dieselPrice={dieselPrice} />
            })}
        </div>
    )
}
